...
z_min, z_max = 0.00226, 1 #0.3
d_min, d_max = None, None

rate_density = 5.798650076411451e-07

# #this is how i calculated the rate density - should be fixed at some point
# rate_per_year = 65000
# z_min, z_max = 0.00226, 1 
# d_min, d_max = shared_utils.get_distance_bounds(d_min=None, d_max=None, z_min=z_min, z_max=z_max)
# V = ((4/3)*np.pi*(d_max**3 - d_min**3))
# new_rate_density = (rate_per_year / V)*(65130/44516)
...
def get_metric_and_su(metric_filename="ShockCooling_metric"):
    '''
